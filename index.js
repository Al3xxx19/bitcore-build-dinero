...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-dinero/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-dinero -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-dinero -o bitcore-lib-dinero.js';
    }
